...
AFRAME.registerComponent("markerhandler", {
  ...
  handleRatings: async function (dish) {
    ...
    var orderSummary = await this.getOrderSummary(tNumber);
    var currentOrders = Object.keys(orderSummary.current_orders); //Object.keys() will get you an array/list of all the keys listed in the json formatted data
    ...
    if(currentOrders.length > 0 && currentOrders == dish.id){
      ...
      swal({
        icon: 'warning',
        title: 'Oops!',
        text: 'There is no dish found to give ratings!!',
        timer: 2500,
        buttons: false
      });
    }
